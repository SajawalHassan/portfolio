  ...
  return (
    <main className="mt-[54px] flex flex-col items-center md:flex-row md:justify-between relative" id="hero">
      <section className="text-center md:text-left relative">
        ...
        <div>
          <Image src={Rain} alt="Rain" width={160} height={112} className="absolute -top-[8rem] right-0 brightness-50 rotate-12 bouncing-image" />
          <Image src={WhiteStar} alt="White Star" width={20} height={20} className="absolute -bottom-[10rem] pulsing-image-md brightness-50" />
          <Image
            src={Arrow}
            alt="Arrow"
            width={122}
        ...
        <div className="relative md:pr-[10rem]">
          ...
          <div>
            ...
            <Image
              ...
              width={15}
              height={15}
              className="absolute bottom-0 -left-10 lg:-left-14 pulsing-image-sm lg:pulsing-image-md brightness-50"
            />
          </div>
        </div>
